...
public class Operacion {
	 ...
	 * entrada para realizar calaculos resultado numero entero de salida n1real
	 * numero real de entrada para el metodo del porcentaje
	 */
	 ...
	 * constructor con todos los parametros de entrada
	 * 
	 * @param n1        El parametro n1 define el numero entero de entrada en los
	 *                  metodos esPrimo, I-esimo y factorial
	 * @param n2        El parametro n2 define el segundo numero entero de
	 *                  entrada(porcentaje) en el metodo porcentaje
	 * @param resultado El parametro resultado define el numero entero de salida
	 *                  realizado el calculo
	 * @param n1real    El parametro n1real define el numero de real de entrada en
	 *                  el metodo porcentaje
	 * 
	 */
	 ...
	 * setter
	 * 
	 * @param n1: numero entero para calcular los metodos esPrimo, I-esimo,
	 *            factorial
	 */
	...
	/**
	 * 
	 * @return n2: numero entero de entrada para introducir el porcentaje en el
	 *         metodo porcentaje
	 */
	 ...
	 * getter
	 * 
	 * @return resultado: numero entero para recojer el resultado una vez ejecutados
	 *         los metodos
	 */
	...
	public void Iesimo(String args[]) {

		double phi = (1.0 + Math.sqrt(5.0)) / 2;

		System.out.println((Math.pow(phi, Integer.parseInt(args[0])) - Math.pow(phi, -1 * Integer.parseInt(args[0])))
				/ Math.sqrt(5));
	...
	public static void Porcentaje(double n1real, double as) {

		double resultado = (double) ((as * n1real) / 100);
